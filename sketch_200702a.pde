...
PImage lobo;
int estado;
int [] pantalla = new int [13];
int [] [] coordenadaBotones= new int [13][2];
void setup() {
  size (800, 600);
  minim = new Minim(this);
  music = minim.loadFile ("sound");
  //music.loop();
...
mostrarPantalla0( );
} else if (estado == 1){ image(oso,0,0,800,600);
mostrarPantalla1();}  else if (estado == 2){image(serpiente,0,0,800,600);
mostrarPantalla2();} else if (estado==3){image(cueva,0,0,800,600);
mostrarPantalla3();} else if (estado==4){image(mareo,0,0,800,600);
mostrarPantalla4();} else if (estado==5){image(lobo,0,0,800,600);
mostrarPantalla5();} else if (estado==6){image(decision,0,0,800,600);
mostrarPantalla6();} else if (estado==7){image(cocodrilo,0,0,800,600);
mostrarPantalla7();} else if (estado==8){image(liana,0,0,800,600);
mostrarPantalla8();} else if (estado==9){image(mon,0,0,800,600);
mostrarPantalla9();} else if (estado==10){image(sigue,0,0,800,600);
mostrarPantalla10();} else if (estado==11){image(sigue,0,0,800,600);
mostrarPantalla11();} else if (estado==12){image(tigre,0,0,800,600);
